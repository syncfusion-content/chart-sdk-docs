...
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/how-to/database/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Database.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/how-to/database/database.cs %}
{% endhighlight %}
{% endtabs %}
