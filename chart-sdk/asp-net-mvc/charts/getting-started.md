...
description: Checkout and learn about getting started with ASP.NET MVC Chart control of Syncfusion Essential JS 2 and more details.
platform: chart-sdk
...
## Add the ASP.NET MVC Chart Control
