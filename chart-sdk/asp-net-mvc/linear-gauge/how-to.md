...
{% include code-snippet/chart-sdk/asp-net-mvc/linear-gauge/how-to/dynamic-gauge/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Dynamic.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/linear-gauge/how-to/dynamic-gauge/dynamic.cs %}
{% endhighlight %}
{% endtabs %}
