---
layout: post
title: Data Labels in ASP.NET MVC 3D Charts | Syncfusion
...
# Data Labels in ASP.NET MVC 3D Charts
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/3d-charts/series/datalabel/smart-data-label/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Smart-data-label.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/3d-charts/series/datalabel/smart-data-label/smart-data-label.cs %}
{% endhighlight %}
{% endtabs %}