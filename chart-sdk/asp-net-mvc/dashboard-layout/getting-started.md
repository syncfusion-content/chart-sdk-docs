---
layout: post
title: Getting Started with ASP.NET MVC DashboardLayout | Syncfusion
description: Checkout and learn about getting started with ASP.NET MVC DashboardLayout control of Syncfusion Essential JS 2 and more details.
platform: chart-sdk
...
{% include code-snippet/chart-sdk/asp-net-mvc/dashboard-layout/getting-started/razor %}
{% endhighlight %}
{% highlight c# tabtitle="HomeController.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/dashboard-layout/getting-started/HomeController.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/dashboard-layout/getting-started-panel/razor %}
{% endhighlight %}
{% highlight c# tabtitle="HomeController.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/dashboard-layout/getting-started-panel/HomeController.cs %}
{% endhighlight %}
{% endtabs %}
