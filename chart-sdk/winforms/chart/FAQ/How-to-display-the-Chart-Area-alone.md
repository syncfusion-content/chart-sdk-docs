...
This can be achieved by setting the Legend.Visible property of WinForms Chart to False, ElementsSpacing property of WinForms Chart to Zero_,_ and__Text property of WinForms Chart to an Empty String.
