...
By using the rendering mode, you can change the type of the Smith chart. The default mode of the Smith chart is impedance.
...
Positive values of reactance lie on the upper region whereas negative values lie on the lower region of the Smith chart.
...
![WinForms SmithChart impedance rendering mode](RenderingMode_images/RenderingMode_img1.jpeg)
...
Positive values of susceptance lie on the lower region whereas negative values lie on the upper region of the Smith chart.
...
![WinForms SmithChart admittance rendering mode](RenderingMode_images/RenderingMode_img2.jpeg)
