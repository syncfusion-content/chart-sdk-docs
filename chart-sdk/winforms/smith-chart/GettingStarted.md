...
Refer to the [control dependencies](https://help.syncfusion.com/windowsforms/control-dependencies#sfsmithchart) section to get the list of assemblies or NuGet packages that need to be added as reference to use the control in any application.
...
# Getting Started with Windows Forms Smith Chart

This section explains the steps required to build an application with the Smith chart.

## Creating a simple Smith chart through the designer

The Smith chart control can be added through the designer by following the below steps.

* Create a new **Windows Forms Application**.
* Drag and drop the Smith chart control from the toolbox into the designer.

![WinForms SmithChart designer support](GettingStarted_images/GettingStarted_img1.jpeg)


* Once you drop the control into the designer page, the Smith chart control will be added successfully along with the required assemblies. The below mentioned assemblies will be added automatically into the application.

    1. Syncfusion.SfSmithChart.WinForms
    2. Syncfusion.Core.WinForms

![WinForms SmithChart assemblies added](GettingStarted_images/GettingStarted_img2.jpeg)
...
For example, in the below image the [`MinorGridlinesVisible`](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.SmithChart.ChartAxis.html#Syncfusion_WinForms_SmithChart_ChartAxis_MinorGridlinesVisible) property of the radial axis is modified via the property grid.

![WinForms SmithChart property grid](GettingStarted_images/GettingStarted_img3.jpeg)


## Creating a simple Smith chart through code

The Smith chart control can be added through code behind by following the below steps.
...
![WinForms SmithChart namespace reference](GettingStarted_images/GettingStarted_img4.jpeg)
...
You can add the data source to the series by using the below properties.

* [`DataSource`](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.SmithChart.ChartSeries.html#Syncfusion_WinForms_SmithChart_ChartSeries_DataSource) : Used to hold the data source. The data source or data collection can be bound with DataSource.
...
You can add each point in the series [`Points`](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.SmithChart.ChartSeries.html#Syncfusion_WinForms_SmithChart_ChartSeries_Points) collection to render the series.
...
To initialize the Smith chart and add it to the application, use the below code.
...
As a result of the above steps, the following output will be reproduced.

![WinForms SmithChart initialization](GettingStarted_images/GettingStarted_img5.PNG)


### Adding header to the Smith chart

The [`Text`](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.SmithChart.SfSmithChart.html#Syncfusion_WinForms_SmithChart_SfSmithChart_Text) property of the Smith chart is used to add a title to the Smith chart control. 
...
The below snippet describes the customization for the axes.
...
![WinForms SmithChart axes](GettingStarted_images/GettingStarted_img6.PNG)

### Adding Series

You can plot a line on the Smith chart by adding a line series.

Initialize the series for representing the data. The marker can be made visible using the [`MarkerVisible`](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.SmithChart.ChartSeries.html#Syncfusion_WinForms_SmithChart_ChartSeries_MarkerVisible) property for indicating the data point.
...
Also, specify the DataSource, ResistanceMember, and ReactanceMember properties to populate the data in the Smith chart.
...
![WinForms SmithChart series](GettingStarted_images/GettingStarted_img7.PNG)
...
![WinForms SmithChart legend](GettingStarted_images/GettingStarted_img9.PNG)
...
![WinForms SmithChart complete code output](GettingStarted_images/GettingStarted_img8.PNG)
