...
![WinForms SmithChart legend](Legend_images/Legend_img8.png)
...
![WinForms SmithChart legend icon](Legend_images/Legend_img4.PNG)
...
![WinForms SmithChart legend alignment](Legend_images/Legend_img5.PNG)


## Customizing legend

Legend can be customized by using the below properties.

[`IconType`](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.SmithChart.ChartLegend.html#Syncfusion_WinForms_SmithChart_ChartLegend_IconType) - This property is used to set the different icon to the legend icon. 
[`IconHeight`](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.SmithChart.ChartLegend.html#Syncfusion_WinForms_SmithChart_ChartLegend_IconHeight) - This property is used to set the height for legend icon. 
[`IconWidth`](https://help.syncfusion.com/cr/windowsforms/Syncfusion.WinForms.SmithChart.ChartLegend.html#Syncfusion_WinForms_SmithChart_ChartLegend_IconWidth) - This property is used to set the width for legend icon. 
...
![WinForms SmithChart legend customization](Legend_images/Legend_img6.PNG)
...
![WinForms SmithChart toggle series visibility](Legend_images/Legend_img7.png)
...
![WinForms SmithChart legend wrap items](Legend_images/Legend_img2.PNG)
