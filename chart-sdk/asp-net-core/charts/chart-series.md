---
layout: post
title: Series in ASP.NET Core Charts | Syncfusion
description: Learn here all about Series in Syncfusion ASP.NET Core Charts component of Syncfusion Essential JS 2 and more.
platform: chart-sdk
