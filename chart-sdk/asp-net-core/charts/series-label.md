...
{% include code-snippet/chart-sdk/asp-net-core/charts/series/series-label/tagHelper %}
{% endhighlight %}

{% highlight c# tabtitle="Series-label.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/charts/series/series-label/series-label.cs %}
{% endhighlight %}
...
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/charts/series/series-label-customization/tagHelper %}
{% endhighlight %}

{% highlight c# tabtitle="Series-label-customization.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/charts/series/series-label-customization/series-label-customization.cs %}
{% endhighlight %}
