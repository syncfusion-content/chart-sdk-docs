---
layout: post
title: Getting Started with ASP.NET Core Smithchart Control
description: Checkout and learn about getting started with ASP.NET Core Smithchart control of Syncfusion Essential JS 2 and more details.
platform: chart-sdk
