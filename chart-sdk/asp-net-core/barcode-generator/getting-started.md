...
description: Checkout and learn about getting started with ASP.NET Core Barcode control of Syncfusion Essential JS 2 and more details.
platform: chart-sdk
...
Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Barcode tag helper in `~/Pages/Index.cshtml` page.

{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/getting-started/barcode/tagHelper %}
{% endhighlight %}
{% endtabs %}

Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>⌘</kbd>+<kbd>F5</kbd> (macOS) to run the app. Then, the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Barcode control will be rendered in the default web browser.
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/getting-started/qrcode/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/getting-started/datamatrix/tagHelper %}
{% endhighlight %}
{% endtabs %}
