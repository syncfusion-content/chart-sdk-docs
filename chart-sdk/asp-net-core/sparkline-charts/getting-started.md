---
layout: post
title: Getting Started with ASP.NET Core Sparkline Control
description: Checkout and learn about getting started with ASP.NET Core Sparkline control of Syncfusion Essential JS 2 and more details.
platform: chart-sdk
