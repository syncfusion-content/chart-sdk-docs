---
layout: post
title: Special Points Customization in ASP.NET Core Sparkline Charts | Syncfusion
...
# Special Points Customization in ASP.NET Core Sparkline Charts
...
{% include code-snippet/chart-sdk/asp-net-core/Sparkline Charts-charts/specialpoints/custom/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Custom.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/Sparkline Charts-charts/specialpoints/custom/custom.cs %}
{% endhighlight %}
{% endtabs %}
...
Tie point color is used to configure the win-loss series type Sparkline Charts's y-value point color. The following code sample shows the tie point color of Sparkline Charts series.

{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/Sparkline Charts-charts/specialpoints/tie-point/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Tie_point.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/Sparkline Charts-charts/specialpoints/tie-point/tie-point.cs %}
{% endhighlight %}
{% endtabs %}
