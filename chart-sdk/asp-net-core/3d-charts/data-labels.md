...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/3d-charts/series/datalabel/smart-data-label/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Smart-data-label.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/3d-charts/series/datalabel/smart-data-label/smart-data-label.cs %}
{% endhighlight %}
{% endtabs %}