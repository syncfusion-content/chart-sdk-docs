---
layout: post
title: Palette in ASP.NET Core HeatMap Chart | Syncfusion
...
# Palette in ASP.NET Core HeatMap Chart
...
In fixed palette type, solid colors are applied to the heat map cells. The data values can be grouped based on the number of colors defined for the heat map. The palette type should be defined as Fixed **Fixed** for theÂ [type](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2~Syncfusion.EJ2.HeatMap.HeatMapPaletteSettings~Type.html)Â property in the `paletteSettings` property.
