...
To add [ASP.NET Core Circular Gauge](https://www.syncfusion.com/aspnet-core-ui-controls/circular-gauge) control in the app, open the NuGet package manager in Visual Studio *(Tools â†’ NuGet Package Manager â†’ Manage NuGet Packages for Solution)*, search for and install the [Syncfusion.AspNetCore.CircularGauge](https://www.nuget.org/packages/Syncfusion.AspNetCore.CircularGauge/) package. All Syncfusion ASP.NET Core packages are available in [nuget.org](https://www.nuget.org/packages?q=syncfusion.EJ2). See the [NuGet packages](https://ej2.syncfusion.com/aspnetcore/documentation/nuget-packages) topic for details.
...
Press <kbd>Ctrl</kbd>+<kbd>F5</kbd> (Windows) or <kbd>âŒ˜</kbd>+<kbd>F5</kbd> (macOS) to launch the application. The [ASP.NET Core Circular Gauge](https://www.syncfusion.com/aspnet-core-ui-controls/circular-gauge) control will render in your default web browser.
