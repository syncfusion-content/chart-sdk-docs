---
layout: post
title: How to hide tooltip in Vue Charts | Syncfusion
description: Learn how to hide and control tooltip visibility in Syncfusion Vue Charts to improve user experience and customize chart interactions.
...
# How to hide tooltip in Vue Charts
...
{% include code-snippet/chart-sdk/vue/charts/axis/category-cs30/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/chart-sdk/vue/charts/axis/category-cs30/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/charts/axis/category-cs30" %}