---
layout: post
title: Advanced Accessibility in Vue Accumulation Charts | Syncfusion
description: Learn here all about Accessibility customization in Syncfusion Vue Accumulation Charts of Syncfusion Essential JS 2 and more.
...
# Advanced Accessibility Configuration in Vue Accumulation Charts
...
{% include code-snippet/chart-sdk/vue/accumulation-chart/accessibility/pie-chart/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/chart-sdk/vue/accumulation-chart/accessibility/pie-chart/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/accumulation-chart/accessibility/pie-chart" %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/chart-sdk/vue/accumulation-chart/accessibility/series/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/chart-sdk/vue/accumulation-chart/accessibility/series/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/accumulation-chart/accessibility/series" %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/chart-sdk/vue/accumulation-chart/accessibility/legend/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/chart-sdk/vue/accumulation-chart/accessibility/legend/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/accumulation-chart/accessibility/legend" %}