...
{% include code-snippet/chart-sdk/vue/linear-gauge/getting-started-cs76/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/chart-sdk/vue/linear-gauge/getting-started-cs76/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/linear-gauge/getting-started-cs76" %}
