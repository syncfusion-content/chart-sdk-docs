...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/sankey-diagram/getting-started/initialize-cs1/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sankey-diagram/getting-started/initialize-cs1" %}
...
{% include code-snippet/chart-sdk/vue/sankey-diagram/getting-started/data-cs1/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/chart-sdk/vue/sankey-diagram/getting-started/data-cs1/app.vue %}
{% endhighlight %}
{% endtabs %}
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sankey-diagram/getting-started/data-cs1" %}
...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/sankey-diagram/getting-started/tooltip-cs1/app.vue %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sankey-diagram/getting-started/tooltip-cs1" %}
