---
layout: post
title: Data Labels in Vue Sparkline Charts | Syncfusion
description: Learn here all about Data labels in Syncfusion Vue Sparkline Charts of Syncfusion Essential JS 2 and more.
control: Data labels 
platform: chart-sdk
documentation: ug
...
# Data Labels in Vue Sparkline Charts
...
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs11/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs11" %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs12/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs12" %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs13/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs13" %}
