---
layout: post
title: Appearance in Vue Sparkline Charts | Syncfusion
description: Learn here all about the Appearance in Syncfusion Vue Sparkline Charts of Syncfusion Essential JS 2 and more.
control: Appearance 
platform: chart-sdk
documentation: ug
...
# Appearance in Vue Sparkline Charts
...
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs1/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs1" %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs2/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs2" %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs3/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs3" %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs4/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs4" %}
