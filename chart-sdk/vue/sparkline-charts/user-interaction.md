---
layout: post
title: User Interaction in Vue Sparkline Charts | Syncfusion
description: Learn here all about User interaction in Syncfusion Vue Sparkline Charts of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs34/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs34" %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs35/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs35" %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs38/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs38" %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs36/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs36" %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs37/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs37" %}
