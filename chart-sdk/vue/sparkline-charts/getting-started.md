...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs14/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs14" %}
...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs15/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs15" %}
...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs16/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/sparkline-charts/getting-started-cs16" %}
