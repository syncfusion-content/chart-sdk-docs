...
description: Learn here all about Series types in Syncfusion Vue Stock Charts of Syncfusion Essential JS 2 and more.
...
To render a hollow candle series, use series [`type`](https://ej2.syncfusion.com/vue/documentation/api/stock-chart/stockSeriesModel#type-string) as `Candle` and set `enableSolidCandle` as false. Now inject `CandleSeries` into the `provide`.
...
{% include code-snippet/chart-sdk/vue/stock-chart/series-types-cs1/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/chart-sdk/vue/stock-chart/series-types-cs1/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/stock-chart/series-types-cs1" %}