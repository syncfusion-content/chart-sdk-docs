...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/range-selector/getting-started-cs9/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/range-selector/getting-started-cs9" %}
...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/range-selector/getting-started-cs10/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/range-selector/getting-started-cs10" %}
