...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/dashboard-layout/getting-started-cs1/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/dashboard-layout/getting-started-cs1" %}
...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/dashboard-layout/getting-started-panel-cs1/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/dashboard-layout/getting-started-panel-cs1" %}
