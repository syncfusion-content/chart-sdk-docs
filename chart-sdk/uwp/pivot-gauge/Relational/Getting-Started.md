---
layout: post
title: Getting Started with UWP Pivot Gauge | SyncfusionÂ®
description: Learn how to get started with the SyncfusionÂ® UWP Pivot Gauge control. Explore setup, configuration, data binding, and customization options.
platform: chart-sdk
