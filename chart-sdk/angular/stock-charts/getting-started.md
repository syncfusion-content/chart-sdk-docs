...
{% include code-snippet/chart-sdk/angular/stock-chart/getting-started-cs1/src/app.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/stock-chart/getting-started-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/stock-chart/getting-started-cs1" %}
