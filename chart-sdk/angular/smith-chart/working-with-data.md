...
{% include code-snippet/chart-sdk/angular/smith-chart/getting-started/smithchart-cs32/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/smith-chart/getting-started/smithchart-cs32/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/smith-chart/getting-started/smithchart-cs32" %}