...
For more information about number and date formatters, refer to the [`internationalization`](https://ej2.syncfusion.com/angular/documentation/common/globalization/internationalization) section.
...
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs46/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs46/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/maps/default-map/datetime-cs46" %}