...
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs19/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs19/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/maps/default-map/datetime-cs19" %}

## Maps title

The [`titleSettings`](https://ej2.syncfusion.com/angular/documentation/api/maps/titleSettingsModel) property configures the title displayed on the Maps component. The title can be customized using the following properties:
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs20/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs20/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/maps/default-map/datetime-cs20" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs21/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs21/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/maps/default-map/datetime-cs21" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs22/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs22/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/maps/default-map/datetime-cs22" %}

## Customizing Maps area

The Maps area has a default background color of **white**. To change the background color, use the [`background`](https://ej2.syncfusion.com/angular/documentation/api/maps/mapsAreaSettingsModel#background) property in [`mapsArea`](https://ej2.syncfusion.com/angular/documentation/api/maps/mapsAreaSettingsModel). The [`border`](https://ej2.syncfusion.com/angular/documentation/api/maps/mapsAreaSettingsModel#border) property in [`mapsArea`](https://ej2.syncfusion.com/angular/documentation/api/maps/mapsAreaSettingsModel) customizes the border around the Maps area.

{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs23/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs23/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/maps/default-map/datetime-cs23" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs24/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs24/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/maps/default-map/datetime-cs24" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs25/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs25/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/maps/default-map/datetime-cs25" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs26/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs26/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/maps/default-map/datetime-cs26" %}
...
The default projection is **Mercator**, which renders the map based on coordinates without stretching. Each projection type represents the Earth's surface differently, affecting how shapes and distances appear on the map. To change the projection, use the [`projectionType`](https://ej2.syncfusion.com/angular/documentation/api/maps/projectionType) property.

{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs27/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/maps/default-map/datetime-cs27/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/maps/default-map/datetime-cs27" %}