...
![Animated demo of dragging chart data points in Angular Charts](../../images/data-edit.gif)
...
{% include code-snippet/chart-sdk/angular/charts/user-interaction/data-editing-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/charts/user-interaction/data-editing-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
