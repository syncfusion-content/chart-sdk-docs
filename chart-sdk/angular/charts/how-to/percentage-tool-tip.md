---
layout: post
title: Percentage tooltip in Angular Charts | Syncfusion
...
# Percentage tooltip in Angular Charts
...
By using the [`tooltipRender`](https://ej2.syncfusion.com/angular/documentation/api/chart/chartModel#tooltiprender) event, you can access the `args.point.y` and `args.series.sumOfPoints` values from the event arguments. You can use these values to calculate the percentage value for each point of pie series. To display the percentage value in tooltip, use the `args.content` property.
