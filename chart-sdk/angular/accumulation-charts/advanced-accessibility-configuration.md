---
layout: post
title: Advanced Accessibility in Angular Accumulation Chart | Syncfusion
...
# Advanced Accessibility Configuration in Angular Accumulation Chart
...
{% include code-snippet/chart-sdk/angular/accumulation-chart/series/pie-cs41/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/accumulation-chart/series/pie-cs41/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/accumulation-chart/series/pie-cs41" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/accumulation-chart/series/pie-cs42/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/accumulation-chart/series/pie-cs42/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/accumulation-chart/series/pie-cs42" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/accumulation-chart/series/pie-cs43/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/accumulation-chart/series/pie-cs43/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/accumulation-chart/series/pie-cs43" %}
