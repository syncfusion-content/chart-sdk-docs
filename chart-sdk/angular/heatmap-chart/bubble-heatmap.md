...
# Bubble HeatMap in Angular HeatMap Chart
...
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeBubble-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeBubble-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeBubble-cs1" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/colorBubble-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/colorBubble-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/heatmap-chart/bubble-heatmap/colorBubble-cs1" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sectorBubble-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sectorBubble-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/heatmap-chart/bubble-heatmap/sectorBubble-cs1" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorTable-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorTable-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorTable-cs1" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorCell-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorCell-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorCell-cs1" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorJsonTable-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorJsonTable-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorJsonTable-cs1" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorJsonCell-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorJsonCell-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorJsonCell-cs1" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorJsonCell-cs2/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorJsonCell-cs2/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/heatmap-chart/bubble-heatmap/sizeAndColorJsonCell-cs2" %}
