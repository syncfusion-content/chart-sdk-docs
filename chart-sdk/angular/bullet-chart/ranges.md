---
layout: post
title: Ranges in Angular Bullet Chart | Syncfusion
...
# Ranges in Angular Bullet Chart
...
{% include code-snippet/chart-sdk/angular/bullet-chart/getting-started/range-cs24/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/bullet-chart/getting-started/range-cs24/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/bullet-chart/getting-started/range-cs24" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/bullet-chart/getting-started/range-cs25/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/bullet-chart/getting-started/range-cs25/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/bullet-chart/getting-started/range-cs25" %}