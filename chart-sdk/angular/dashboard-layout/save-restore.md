...
{% include code-snippet/chart-sdk/angular/dashboard-layout/save-restore-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="styles.css" %}
{% include code-snippet/chart-sdk/angular/dashboard-layout/save-restore-cs1/src/styles.css %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/dashboard-layout/save-restore-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/dashboard-layout/save-restore-cs1" %}
