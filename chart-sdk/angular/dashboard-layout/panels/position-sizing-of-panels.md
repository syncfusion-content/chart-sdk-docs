...
{% include code-snippet/chart-sdk/angular/dashboard-layout/positioning-of-panels-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="styles.css" %}
{% include code-snippet/chart-sdk/angular/dashboard-layout/positioning-of-panels-cs1/src/styles.css %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/dashboard-layout/positioning-of-panels-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/dashboard-layout/positioning-of-panels-cs1" %}

## Sizing of panels

Panel size can be controlled by defining the [`sizeX`](https://ej2.syncfusion.com/angular/documentation/api/dashboard-layout/panelModel#sizex) and [`sizeY`](https://ej2.syncfusion.com/angular/documentation/api/dashboard-layout/panelModel#sizey) properties. The `sizeX` property defines the panel width and the `sizeY` property defines the panel height, both measured in cell count. These properties are helpful in designing a dashboard, where the content of each panel may vary in size.
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/dashboard-layout/sizing-of-panels-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="styles.css" %}
{% include code-snippet/chart-sdk/angular/dashboard-layout/sizing-of-panels-cs1/src/styles.css %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/dashboard-layout/sizing-of-panels-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/dashboard-layout/sizing-of-panels-cs1" %}
