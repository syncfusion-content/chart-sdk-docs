---
layout: post
title: Logarithmic Axis in Angular 3D Chart | Syncfusion
...
# Logarithmic axis in Angular 3D Chart
...
{% include code-snippet/chart-sdk/angular/3d-charts/logarithmic-axis/logatithmic-axis-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/3d-charts/logarithmic-axis/logatithmic-axis-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/3d-charts/logarithmic-axis/logatithmic-axis-cs1" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/3d-charts/logarithmic-axis/logatithmic-axis-cs2/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/3d-charts/logarithmic-axis/logatithmic-axis-cs2/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/3d-charts/logarithmic-axis/logatithmic-axis-cs2" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/3d-charts/logarithmic-axis/logatithmic-axis-cs3/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/3d-charts/logarithmic-axis/logatithmic-axis-cs3/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/3d-charts/logarithmic-axis/logatithmic-axis-cs3" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/3d-charts/logarithmic-axis/logatithmic-axis-cs4/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/3d-charts/logarithmic-axis/logatithmic-axis-cs4/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/3d-charts/logarithmic-axis/logatithmic-axis-cs4" %}