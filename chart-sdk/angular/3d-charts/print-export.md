---
layout: post
title: Print and Export in Angular 3D Chart | Syncfusion
...
# Print and Export in Angular 3D Chart
...
{% include code-snippet/chart-sdk/angular/3d-charts/print-export/print-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/3d-charts/print-export/print-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/3d-charts/print-export/print-cs1" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/chart-sdk/angular/3d-charts/print-export/print-cs2/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/3d-charts/print-export/print-cs2/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/3d-charts/print-export/print-cs2" %}
