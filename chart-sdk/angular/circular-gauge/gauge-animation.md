...
# Animation in Angular Circular Gauge
...
{% include code-snippet/chart-sdk/angular/circular-gauge/gauge-animation-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/circular-gauge/gauge-animation-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/circular-gauge/gauge-animation-cs1" %}
