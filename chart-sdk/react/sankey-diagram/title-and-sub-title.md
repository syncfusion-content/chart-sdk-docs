...
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/title-subtitle/basic-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/title-subtitle/basic-cs1/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/sankey-diagram/preview-sample/title-subtitle/basic-cs1" %}
...
{% tabs %}
{% highlight js tabtitle="app.jsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/title-subtitle/customization-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/title-subtitle/customization-cs1/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/sankey-diagram/preview-sample/title-subtitle/customization-cs1" %}
...
{% tabs %}
{% highlight js tabtitle="app.jsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/title-subtitle/title-only-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/title-subtitle/title-only-cs1/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/sankey-diagram/preview-sample/title-subtitle/title-only-cs1" %}
...
{% tabs %}
{% highlight js tabtitle="app.jsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/title-subtitle/alignment-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/title-subtitle/alignment-cs1/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/sankey-diagram/preview-sample/title-subtitle/alignment-cs1" %}
