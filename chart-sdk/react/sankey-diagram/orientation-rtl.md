---
layout: post
title: Orientation and RTL in React Sankey Diagram | Syncfusion
description: Learn how to set the orientation and enable right-to-left rendering on the Syncfusion React Sankey Diagram Component for languages like Arabic and Hebrew.
...
# Orientation and RTL in React Sankey Diagram
...
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/orientation-rtl/horizontal-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/orientation-rtl/horizontal-cs1/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/sankey-diagram/preview-sample/orientation-rtl/horizontal-cs1" %}
...
{% tabs %}
{% highlight js tabtitle="app.jsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/orientation-rtl/vertical-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/orientation-rtl/vertical-cs1/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/sankey-diagram/preview-sample/orientation-rtl/vertical-cs1" %}
...
{% tabs %}
{% highlight js tabtitle="app.jsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/orientation-rtl/rtl-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/orientation-rtl/rtl-cs1/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/sankey-diagram/preview-sample/orientation-rtl/rtl-cs1" %}
...
{% tabs %}
{% highlight js tabtitle="app.jsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/orientation-rtl/rtl-horizontal-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/orientation-rtl/rtl-horizontal-cs1/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/sankey-diagram/preview-sample/orientation-rtl/rtl-horizontal-cs1" %}
