---
layout: post
title: Tooltip in React Sankey Diagram | Syncfusion
description: Learn how to enable and customize tooltips in the Syncfusion React Sankey Diagram Component with template and format options.
control: Tooltip
platform: chart-sdk
documentation: ug
...
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/tooltip/basic-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/tooltip/basic-cs1/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/sankey-diagram/preview-sample/tooltip/basic-cs1" %}
...
{% tabs %}
{% highlight js tabtitle="app.jsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/tooltip/customization-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/tooltip/customization-cs1/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/sankey-diagram/preview-sample/tooltip/customization-cs1" %}
...
{% tabs %}
{% highlight js tabtitle="app.jsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/tooltip/format-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/tooltip/format-cs1/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/sankey-diagram/preview-sample/tooltip/format-cs1" %}
...
{% tabs %}
{% highlight js tabtitle="app.jsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/tooltip/format-cs2/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/tooltip/format-cs2/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/sankey-diagram/preview-sample/tooltip/format-cs2" %}
...
{% tabs %}
{% highlight js tabtitle="app.jsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/tooltip/rendering-event-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="app.tsx" %}
{% include code-snippet/chart-sdk/react/sankey-diagram/code-path/tooltip/rendering-event-cs1/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/sankey-diagram/preview-sample/tooltip/rendering-event-cs1" %}
