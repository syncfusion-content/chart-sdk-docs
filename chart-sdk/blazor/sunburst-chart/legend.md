...
* `Background`: Specifies the background color of the legend container. Any valid CSS color value is accepted, for example a hex value like `#F5F5F5`, an RGB value like `rgb(173, 216, 230)`, or a named CSS color such as `skyblue`.
