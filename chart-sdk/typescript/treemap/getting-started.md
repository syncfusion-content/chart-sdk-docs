...
{% include code-snippet/chart-sdk/typescript/treemap/getting-started-cs1/index.ts %}
{% endhighlight %}
{% endtabs %}
...
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/typescript/treemap/getting-started-cs1" %}
