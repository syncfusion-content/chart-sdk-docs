...
{% include code-snippet/chart-sdk/typescript/range-selector/getting-started-cs10/index.ts %}
{% endhighlight %}
{% highlight ts tabtitle="datasource.ts" %}
{% include code-snippet/chart-sdk/typescript/range-selector/getting-started-cs10/datasource.ts %}
{% endhighlight %}
{% endtabs %}
...
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/typescript/range-selector/getting-started-cs10" %}
