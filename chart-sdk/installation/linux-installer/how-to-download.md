...
## Download the License Version
   ...
   N> An active Syncfusion license (Community or Commercial) associated with your account is required to download the licensed installer.

1. Syncfusion licensed products will be available in the [License & Downloads](https://www.syncfusion.com/account/downloads) page under your registered Syncfusion account.
2. You can view all the licenses (both active and expired) associated with your account.
3. You can download the Chart SDK Linux licensed installer by going to **More Download Options** (element 3 in the screenshot below).

   ![License and downloads of Syncfusion Chart SDK](images/license-download.png)

4. For Linux OS, the ZIP format is available for download.
5. After the download completes, verify the integrity of the ZIP file before extracting.
