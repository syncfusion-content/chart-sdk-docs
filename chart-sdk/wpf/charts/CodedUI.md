---
layout: post
title: Coded UI in WPF Charts | SyncfusionÂ®
...
To test WPF Charts with CUITs, build the Extension Project and place it in the mentioned location. You can get the Extension Project  of WPF Charts fromÂ [`here`](https://www.syncfusion.com/downloads/support/directtrac/general/ze/CodedUI-1453395823.zip).
...
The following properties are for each of the UI elements in WPF Charts,
