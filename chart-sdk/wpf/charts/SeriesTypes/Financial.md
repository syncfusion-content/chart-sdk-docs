---
layout: post
title: Financial Chart in WPF Charts | SyncfusionÂ®
description: Financial series in the WPF Chart visualize stock market and financial data using specialized chart types for trend analysis.
platform: chart-sdk
control: SfChart
documentation: ug
