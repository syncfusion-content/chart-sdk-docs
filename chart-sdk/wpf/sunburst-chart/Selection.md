...
layout: post
title: Selection in WPF Sunburst Chart | SyncfusionÂ®
...
* HighlightByColor â€“ To display the selected segment appearance using a brush.
...
* Child â€“ To select the child of the selected parent.
* Group â€“ To select the entire categories in the group.
* Parent â€“ To select the parent of the selected child.
