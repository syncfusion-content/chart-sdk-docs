---
layout: post
title: Getting Started with WPF OLAP Gauge | SyncfusionÂ®
description: Learn how to get started with the SyncfusionÂ® WPF OLAP Gauge control. Explore setup, features, examples, and customization options.
platform: chart-sdk
control: OLAP Gauge
documentation: ug
...
The OLAP gauge control can be initialized and added to an application in the following ways:
...
3. From the toolbox, select the OLAP gauge control under the â€œSyncfusion BI WPFâ€ group, and then drag it to the designer section of the MainPage.xaml file.

![WPF OLAP Gauge Getting-Started Image1](Getting-Started_images/Getting-Started_img1.png)

4. Then, name the added OLAP gauge control as â€œOlapGauge1â€ in MainPage.xaml to refer to it in the code-behind as follows:
...
5. Then, name the added OLAP gauge control as "OlapGauge1" in MainPage.xaml to refer to it in the code-behind as follows:
...
To add the OlapReport and OlapDataManager in the application, refer to the [OlapReport and OlapDataManager declaration](#olapreport-and-olapdatamanager-declaration) section.
