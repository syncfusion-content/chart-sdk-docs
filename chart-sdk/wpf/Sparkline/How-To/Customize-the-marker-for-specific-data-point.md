...
You can customize the marker for a specific data point with a custom template for WPF Line Sparkline and WPF Area Sparkline. To customize the marker, inherit the `MarkerTemplateSelector` class and override the `SelectTemplate` method.
