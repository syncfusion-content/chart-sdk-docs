---
layout: post
title: Getting Started with WPF HeatMap | SyncfusionÂ®
description: Learn how to get started with the SyncfusionÂ® WPF HeatMap control. Explore setup, features, examples, and customization options.
platform: chart-sdk
control: SfHeatMap
documentation: ug
...
N> Starting with v16.2.0.x, if you reference SyncfusionÂ® assemblies from trial setup or from the NuGet feed, you also have to include a license key in your projects. Please refer to this [link](https://help.syncfusion.com/common/essential-studio/licensing/overview) to know about registering SyncfusionÂ® license key in your WPF application to use our components.
