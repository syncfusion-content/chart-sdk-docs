...
An OLAP pager (user control) is included and bound with the OlapDataManager object of the WPF OLAP Chart. To enable paging, set the `EnablePaging` property to true.
