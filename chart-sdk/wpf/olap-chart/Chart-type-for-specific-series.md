---
layout: post
title: Chart Type for Specific Series in WPF Olap Chart| SyncfusionÂ®
...
The WPF OLAP Chart in WPF supports changing the chart type of each series using the context menu.
