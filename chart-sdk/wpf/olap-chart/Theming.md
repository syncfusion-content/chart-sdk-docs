...
The `VisualStyle` property allows users to set the visual style of the WPF OLAP Chart control. The following code sample demonstrates how theming is added to the WPF OLAP Chart control.
