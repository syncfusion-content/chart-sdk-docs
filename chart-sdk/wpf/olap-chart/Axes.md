---
layout: post
title: Axes in WPF Olap Chart | SyncfusionÂ®
...
The label font settings of the primary and secondary axes can be easily applied to a WPF OLAP Chart by specifying the label font properties, which are available under the primary and secondary axes of it.
