---
layout: post
title: ES5 getting started with JavaScript Accumulation Charts | Syncfusion
description: Check out and learn about ES5 getting started with JavaScript Accumulation Charts control of Syncfusion Essential JS 2 and more details.
platform: chart-sdk
...
# Getting Started with Syncfusion® JavaScript (ES5) Accumulation Charts
...
<html lang="en">
  <head>
    ...
    <script src="https://cdn.syncfusion.com/ej2/34.1.29/ej2-charts/dist/global/ej2-charts.min.js"></script>
  </head>
...
* [Pie Chart](pie)
* [Doughnut Chart](pie-dough-nut)
* [Funnel Chart](funnel)
* [Pyramid Chart](pyramid)
* [Accumulation Chart Legend](legend)
* [Accumulation Chart Data Labels](data-label)
* [Accumulation Chart Tooltip](tool-tip)
* [API Reference: AccumulationChart](https://ej2.syncfusion.com/javascript/documentation/api/accumulation-chart)
* [API Reference: AccumulationSeries](https://ej2.syncfusion.com/javascript/documentation/api/accumulation-chart/accumulationseriesmodel)
