---
layout: post
title: Internationalization in JavaScript Linear Gauge | Syncfusion
description: Globalize the number content of the JavaScript Linear Gauge using the format property to support different cultures and numeric formats.
platform: JavaScript
...
# Internationalization in JavaScript Linear Gauge
