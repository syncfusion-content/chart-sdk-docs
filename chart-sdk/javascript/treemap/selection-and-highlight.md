---
layout: post
title: Selection and highlight in JavaScript TreeMap | Syncfusion
description: Learn here all about Selection and highlight in Syncfusion JavaScript TreeMap of Syncfusion Essential JS 2 and more.
platform: chart-sdk
control: TreeMap
documentation: ug
...
# Selection and highlight in JavaScript TreeMap
...
{% include code-snippet/chart-sdk/javascript/treemap/selectionAndHighlight-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/javascript/treemap/selectionAndHighlight-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/javascript/treemap/selectionAndHighlight-cs1" %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/chart-sdk/javascript/treemap/selectionAndHighlight-cs2/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/javascript/treemap/selectionAndHighlight-cs2/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/javascript/treemap/selectionAndHighlight-cs2" %}