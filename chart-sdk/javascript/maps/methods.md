---
layout: post
title: Methods in JavaScript Maps component | Syncfusion
description: Learn here all about the methods in the Syncfusion JavaScript Maps component of Syncfusion Essential JS 2 and more.
platform: chart-sdk
control: Maps 
...
{% include code-snippet/chart-sdk/javascript/maps/method-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/javascript/maps/method-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/javascript/maps/method-cs1" %}
