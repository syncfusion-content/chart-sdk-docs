/**
 * Column series - Expose series and point in legendRender event.
 */
import { Chart, ColumnSeries, Category, Legend, ILegendRenderEventArgs, EmitType } from '@syncfusion/ej2-charts';
