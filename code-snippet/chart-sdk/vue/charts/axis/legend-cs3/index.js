...
new Vue({
	...
	template: `
    <div id="app">
         <ejs-chart id="container" :title='title' :primaryXAxis='primaryXAxis' :primaryYAxis='primaryYAxis' :legendSettings='legendSettings' :legendRender='legendRender'>
            <e-series-collection>
                <e-series :dataSource='seriesData' type='Column' xName='x' yName='y' name='Annual Sales' :marker='marker'> </e-series>
            </e-series-collection>
        </ejs-chart>
    </div>
`,
